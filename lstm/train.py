...
from alg.lstm.loader import doh_dataloader
...
from alg.lstm.model import LSTMNet
data_class = {"Doh": 3,"Malicious_DoH":3}
data_lr = {"Doh": 0.0001,"Malicious_DoH":0.0001}
data_feats = {"Doh": 32, "Malicious_DoH":32}
weight = 1.5
beta = 2.0
delta = 1.5
input_size = 1  # 假设网络流量数据有10个特征
...
if __name__ == '__main__':
    ...
    model_save_path1 = 'alg/model/lstm-doh.pth'
    model_save_path2 = 'alg/model/lstm-malicious_doh.pth'
    if args.dataset == 'Doh':
