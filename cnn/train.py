...
import numpy as np
import torch
from alg.cnn.model import CNN
from alg.cnn.loader import doh_dataloader
from torch import nn
import time
from sklearn.metrics import confusion_matrix
from alg.krcnn.loss import CustomMulticlassLoss
from alg.krcnn.focalloss import FocalLoss
data_class = {"Doh": 3, "Malicious_DoH":3}
data_lr = {"Doh": 0.001, "Malicious_DoH":0.0001}
data_feats = {"Doh": 29, "Malicious_DoH":32}
weight = 1.5
beta = 2.0
delta = 1.0
...
def fit(dataset, train_loader, test_loader, valid_loader, num_class, model_save_path,loss_value , epoch, per_print=100):
    ...
    net = CNN(data_feats[dataset], num_class)
    net = net.to(device)
...
if __name__ == '__main__':
    ...
    data_path1 = 'alg/Dataset/data-doh1.csv'
    data_path2 = 'alg/Dataset/dataset_malicious_doh3.csv'
    model_save_path1 = 'alg/model/cnn-doh_combine.pth'
    model_save_path2 = 'alg/model/cnn-malicious_doh.pth'
    epoch = args.epoch
    if args.dataset == 'Doh':
