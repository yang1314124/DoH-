...
data_path = "C:/Users/Administrator/Desktop/trafficdet-main/alg/CSVs/"
# data_path = "D:/PCAPs/"
# malicious_doh_df = pd.read_csv(data_path+"malicious_doh4.csv", low_memory=False, delimiter=',')
malicious_doh_df = pd.read_csv(data_path+"malicious_doh4.csv", low_memory=False, delimiter=',')
# # non_doh_df = pd.read_csv(data_path+"normal_doh4.csv", low_memory=False, delimiter=',')
#
#
# # malicious_doh_df['Label'] = 2
# malicious_doh_df['Label'] = malicious_doh_df['Label'].replace({'dns2tcp': 0, 'dnscat2': 1, 'iodine':2})
# data = shuffle(pd.concat([non_doh_df, malicious_doh_df]))
# print(data.head())
#
#
# print(data.columns)
...
data = malicious_doh_df.fillna(0)
# print(data.isna().sum())
